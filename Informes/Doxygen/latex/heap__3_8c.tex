...
References v\+Application\+Malloc\+Failed\+Hook(), v\+Task\+Suspend\+All(), and x\+Task\+Resume\+All().



Referenced by Crear\+Hall\+Sensor(), Crear\+Shifter(), and x\+Queue\+Generic\+Create().
...
References v\+Task\+Suspend\+All(), and x\+Task\+Resume\+All().



Referenced by Eliminar\+Hall\+Sensor(), Eliminar\+Shifter(), v\+Queue\+Delete(), and x\+Queue\+Generic\+Create().
