 ...
 *----------------------------------------------------------*/
/*
 * Para habilitar el uso de sets
 */
#define configUSE_QUEUE_SETS        1
/*
 * Para que el sistema se comporte como apropiativo, es decir que el squeduler dejara correr a la tarea con mayor prioridad que lo necesite
 ...
 *
 * configUSE_TIME_SLICING en 1 indica que las tareas que compartan prioridad
 * tambien compartiran el mismo tiempo de procesador (Se les deja correr el
 * mismo tiempo a cada tarea).
 */
#define configUSE_TIME_SLICING		1
/*
 * Para que en momentos ociosos el sistema llame a vApplicationIdleHook.
 */
#define configUSE_IDLE_HOOK			1

#define configMAX_PRIORITIES		( ( unsigned portBASE_TYPE ) 8 )
/*
 * Para poder hacer uso de la funcion vApplicationTickHook.
 */
#define configUSE_TICK_HOOK			1
/*
 * Frecuencia del core del chip
 */
#define configCPU_CLOCK_HZ			( ( unsigned long ) SystemCoreClock )
/*
 * Cantidad de ticks para que interrumpa el sistema operativo
 */
#define configTICK_RATE_HZ			( ( portTickType ) 3000 )
/*
 * Tamaño de pila para la tarea osciosa
 */
...
/*
 * Si configIDLE_SHOULD_YIELD se settea en 1, IdleTask va a correr por una unica iteracion de loop
 * en cada Time Slice y luego le dejará el procesador a otras tareas en Ready state de la misma
 * prioridad de IdleTask para que puedan correr.
 * Si se settea en 0, IdleTask compartirá el mismo tiempo de procesador con las demas tareas de
 * la misma prioridad.
 */
...
/*
 * Usado para apps que requieran ahorro de energia
 */
#define configUSE_TICKLESS_IDLE		0
#define configSUPPORT_DYNAMIC_ALLOCATION 1 //para usar xSemaphoreCreate, jamas me funciono, vieja version de FreeRTOS.
