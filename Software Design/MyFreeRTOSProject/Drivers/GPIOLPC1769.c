/**
 * @file GPIOLPC1769.c
 * @brief Funciones de manejo de GPIO.
 */
...
/********************************************************************************
	\fn  void toggle (uint8_t puerto , uint8_t pin)
	\brief Niega el ESTADO de un determinado PIN de un determinado PUERTO.
	\author Germán Castro
 	\param [in] puerto: puerto con el que se va a trabajar
 	\param [in] pin:	pin a consultar estado
	\return:	void
*/
